...
//    	aa.addSubgraph("commerces");
	...
	*****************************************************************************************/
	...
	public RestResponse<ProductTemplate> addProductTemplate(@RequestBody ProductTemplate pt, HttpSession session, Locale locale, Model model)
    {
    	...
    	try 
    	{
    		...
    		// TODO proposer les fiches produits qui portent le m̻me nom pour faciliter la recherche et check s'il ne s'agit pas d'une modification d'une fiche existante plut̫t que d'un ajout
	...
	*****************************************************************************************/
	...
	// (pr̩venir l'user que la suppression de la fiche entrainera la suppression des produits en vente)
