...
public class Main 
{
	...
	public static void setupDataBase()
	{
		...
		*/
		...
		mBf.addProductTemplate(new ProductTemplate("Le Victor", "Fourme d’Ambert (bleu crémeux) oignons confits, coriandre, sauce Tonton Fernand (mayonnaise délicatement sucrée", "0000001", true, 16.0, 11.2, "levictor.jpg"));
		mBf.addProductTemplate(new ProductTemplate("Le Big Fernand", "Bœuf (race à viande) tomme de Savoie au lait cru, tomates séchées, persil plat, sauce Tata Fernande (sauce cocktail maison)", "0000001", true, 16.0, 11.2, "lebigfernand.jpg"));
