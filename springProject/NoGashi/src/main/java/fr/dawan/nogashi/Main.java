...
public class Main 
{
	...
	public static void setupDataBase()
	{
		...
		// TODO Ajouter des produits pour chaque commerce.
		...
		mP.addProductTemplate(new ProductTemplate("La sandwich viennois mixte crudités", "Le viennois mixte crudités substitue le jambon fromage crudité. Un pain viennois tendre, moelleux et un sandwich plus généreux pour le plus grand plaisir des gourmands.<br>Un pain viennois compsoé de jambon blanc de qualité supérieur, d'emmental, de salade et de la fraicheur d'une tartinade nature.<br>Gluten – blé – seigle – œufs - lait", "0000001", true, 5.60, 3.92));
