...
public class Main 
{
	...
	public static void setupDataBase()
	{
		...
		*/
		...
		/* ---------- COMMERCES ---------- */
		Commerce mBC_c1 = new Commerce("Basilic & Co", "362 521 879 00033", new Address("80 rue Nationale", "", "59800", "Lille", "France", 3.059697, 50.635931), "basilic.png", "basilic-and-co-pizza.png", "24, c'est le nombre de restaurants que compte désormais le réseau Basilic & Co, depuis l'ouverture de son nouveau point de vente de Tours Nord. Depuis début Novembre 2019, Aurélien Harnay et Geoffrey Vilain vous accueillent au 42 rue Daniel Mayer, en plein coeur de Monconseil. Très impliqués localement, ils s'investissent pour faire de leur pizzeria de terroir l'un des lieux de vie incontournables du quartier. Leur ouverture s'est traduite par un succès retentissant, pour le plus grand bonheur des Tourangeaux !", swTmp, "Nationale"); mBC_c1.setMerchant(mBC);		
		Commerce mDj_c1 = new Commerce("Daily-juicery", "362 521 879 00032", new Address("380 rue Léon Gambetta", "", "59000", "Lille", "France", 3.04787, 50.6267), "daily-juicery.png", "daily-juicery.png", "Buvez et mangez vos 5 fruits et légumes par jour grâce à nos jus DETOX pressés à froid & à nos préparations HEALTHY  100% à base de fruits et légumes frais et de saison, sans sucres ajoutés ni conservateurs !", swTmp, "Gambetta"); mDj_c1.setMerchant(mDj);
		Commerce mBm_c1 = new Commerce("Boulangerie-Mathieu", "795 335 793 00027", new Address("82 rue du Molinel", "", "59000", "Lille", "France", 3.06686, 50.6341), "boulangerie-mathieu.jpeg", "boulangerie-mathieu.jpeg", "Un bon pain c’est tout d’abord un bon partenariat avec son meunier qui saura apporter des farines de qualité, mais c’est aussi le temps de travail avec de bons levains. Nous avons à cœur de créer et de réaliser des recettes respectueuses de l’environnement pour vous proposer une variété de pains bio, composés d’une multitude de céréales.", swTmp, "Molinel"); mBm_c1.setMerchant(mBm);
		Commerce mP_c1 = new Commerce("Paul", "403 052 111 00420", new Address("19 place Charles de Gaulle", "", "59000", "Lille", "France", 3.0630005, 50.6367832), "paul.jpg", "paul.jpg", "Après 125 ans d’existence, PAUL est l’ambassadeur de l’Art de vivre à la française. Les équipes de l’enseigne, présentent dans plus de 33 pays, partagent le goût du travail bien fait, la joie d’offrir chaque jour des produits de qualité et d’accueillir les clients dans un cadre enchanteur et unique.", swTmp, "Charles de Gaulle"); mP_c1.setMerchant(mP);
		Commerce mBf_c1 = new Commerce("Big Fernand", "830 134 458 00017", new Address("107 Rue Esquermoise", "", "59000", "Lille", "France", 3.0586802, 50.6388127), "big-fernand.png", "big-fernand.png", "\"Faudro qt'arrêtes eud' mier des burgers, mies des hamburgés, che ben meilleu\"<br/>L'équipe", swTmp, "Esquermoise"); mBf_c1.setMerchant(mBf);
		Commerce mBf_c2 = new Commerce("Big Fernand", "830 134 458 00017", new Address("10 Rue Faidherbe", "", "59000", "Lille", "France", 3.0657011, 50.6369357), "big-fernand.png", "big-fernand.png", "\"Faudro qt'arrêtes eud' mier des burgers, mies des hamburgés, che ben meilleu\"<br/>L'équipe", swTmp, "Faidherbe"); mBf_c2.setMerchant(mBf);
		...
		mDj.addProductTemplate(new ProductTemplate("Green 5,0 – Jus Detox 100% naturel", "Concombre - Pomme - Chou kale -Céleri - Laitue - Menthe - Citron vert<br>Allié minceur - Vitamines C  et K1 - Contribue au renforcement des os", "0000001", true, 7.0, 4.9, "green-jus detox naturel-daily.jpg"));
		mDj.addProductTemplate(new ProductTemplate("Roots 1,2 – Jus Detox 100% naturel", "Orange - Pomme - Carotte - Betterave -  Gingembre - Citron vert<br>Aide à protéger des maladies - Energisant - Vitamines C - Aide la circulation du sang", "0000001", true, 7, 4.9, "roots-jus detox naturel-daily.jpg"));
		
		/* ---------- PRODUITS BOULANGERIE MATHIEU ---------- */
		// http://laboulangeriemathieu.com/portfolio-items/nos-pains/
		mBm.addProductTemplate(new ProductTemplate("Pain aux fromages", "Farine : type 65 label rouge, emmental, mimolette", "0000001", true, 1.50, 0.99, "painfromage-mathieu.jpg"));
		mBm.addProductTemplate(new ProductTemplate("Pain aux olives", "Farine : type 65 label rouge, olives vertes, herbes de Provence, huile d’olive", "0000001", true, 1.45, 0.99, "pain-olives-mathieujpg.jpg"));
		mBm.addProductTemplate(new ProductTemplate("Pain au chorizo", "Farine : type 65 label rouge, chorizo, épices mexicaines.", "0000001", true, 1.40, 0.99, "pain-chorizo-mathieu.jpg"));
		mBm.addProductTemplate(new ProductTemplate("Pain tradition", "Farine : t65 label rouge, levain liquide de blé", "0000001", true, 1.35, 0.99, "pain-tradition.jpg"));
		mBm.addProductTemplate(new ProductTemplate("Pain seigle (sans blé)", "Farine : bio seigle type 130 sur meule de pierre, levain dur de seigle.", "0000001", true, 1.85, 1.25, "pain-segles-mathieu.jpg"));
		
		/* ---------- PRODUITS PAUL ---------- */
		// https://www.paul.fr/fr/3-nos-produits
		mP.addProductTemplate(new ProductTemplate("Le fromage blanc miel et granola", "Finissez votre déjeuner sur une note sucrée avec ce dessert gourmand. Un fromage blanc accompagné d'un granola enrichi de cranberries, raisins secs et d'amandes effilées<br>Gluten – blé – lait – fruits à coque – noix - sulfite", "0000001", true, 3.82, 2.67, "fromage-blanc-miel-et-granola-paul.jpg"));
		mP.addProductTemplate(new ProductTemplate("Le riz au lait mangue", "Un dessert délicieusement crémeux accompagné de mangues. Ce riz au lait est composé de compote mangue citron vert, de riz au lait de coco et de graines de chia.<br>Gluten – avoine – lait – fruit à coque - amande", "0000001", true, 4.12, 2.88, "riz-au-lait-mangue-paul.jpg"));		
		...
		mBf.addProductTemplate(new ProductTemplate("Le Pierrot", "Haut de cuisse de poulet fermier des Landes marinée label rouge, Sainte-Maure-de-Touraine (fromage de chèvre AOP), de la riquette poivrée et notre sauce mayonnaise maison aux olives, tomates et basilic + Frites maison (patates lavées, épluchées, coupées sur place) ou salade + Breuvage", "0000001", true, 16.0, 11.2, "le-pierrot-fernand.jpeg"));
		mBf.addProductTemplate(new ProductTemplate("Le Lucien (végétarien)", "Gros Champignon de Paname avec de la Tomme de Savoie au lait cru fondue, des tomates séchées, des oignons confits, de la ciboulette ciselée et notre sauce mayonnaise maison délicatement sucrée + Frites maison (patates lavées, épluchées, coupées sur place) ou salade + Breuvage + Dessert artisanal", "0000001", true, 16.0, 11.2, "lucien-vegetarien-fernand.jpeg"));
		mBf.addProductTemplate(new ProductTemplate("Le Victor", "Fourme d’Ambert (bleu crémeux) oignons confits, coriandre, sauce Tonton Fernand (mayonnaise délicatement sucrée", "0000001", true, 16.0, 11.2, "NoProduct.jpg"));
		mBf.addProductTemplate(new ProductTemplate("Le Big Fernand", "Bœuf (race à viande) tomme de Savoie au lait cru, tomates séchées, persil plat, sauce Tata Fernande (sauce cocktail maison)", "0000001", true, 16.0, 11.2, "NoProduct.jpg"));
		mBf.addProductTemplate(new ProductTemplate("Le Bartholomé", "Bœuf (race à viande), raclette des Alpes au lait cru, poitrine de porc fumée, oignons confits – ciboulette, sauce BB Fernand (sauce barbecue big fernand)", "0000001", true, 16.0, 11.2, "NoProduct.jpg"));
