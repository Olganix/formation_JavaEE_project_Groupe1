...
public class Main 
{
	...
	public static void setupDataBase()
	{
		...
		la.add(new Association(	new User("Les Gars'pilleurs", "lesgarspilleurs@gmail.com", BCrypt.hashpw("totototo", BCrypt.gensalt()), UserRole.ASSOCIATION, "06.22.99.87.92",	 			new Address("", "", "59000", "Lille", "France", 3.0667, 50.6333), true , true, "LesGarspilleurs.png"), "362 521 878", "W751212518") );
		...
		// TODO corriger apres tous ce qu'il y a apres (wtf)
