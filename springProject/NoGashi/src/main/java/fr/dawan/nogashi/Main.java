...
public class Main 
{
	...
	public static void setupDataBase()
	{
		...
		Individual u = new Individual(	new User("User", "user@noghasi.org", BCrypt.hashpw("totototo", BCrypt.gensalt()), UserRole.INDIVIDUAL, "01.01.01.01.01", new Address("59, Rue User", "", "59000", "Lille", "France", 00.00, 00.00), true , true, "user.jpg"), 	new CreditCard("MasterCard", "4539 1593 1309 2658", "User", "2020-04-23", "092"));	li.add(u);
		...
		li.add(new Individual(	new User("Anaïs Despins", "anais.despins@noghasi.org", BCrypt.hashpw("totototo", BCrypt.gensalt()), UserRole.INDIVIDUAL, "01.56.78.43.93", new Address("9, boulevard d'Alsace", "", "59000", "Lille", "France", 00.00, 00.00), true , true, "F_0001.jpg"), 	new CreditCard("Visa", "4539 1593 1309 2658", "Anaïs Despins", "2020-04-23", "092"))); li.get(li.size()-1).setPhoneNumber2("06.77.77.77.16"); 
		li.add(new Individual(	new User("Éléonore Asselin", "eleonore.asselin@noghasi.org", BCrypt.hashpw("totototo", BCrypt.gensalt()), UserRole.INDIVIDUAL, "03.88.05.42.57", 	new Address("29, Chemin Challet", "", "59000", "Lille", "France", 00.00, 00.00), true , true, "F_0046.jpg"), 		new CreditCard("MasterCard", "4929 2911 9298 7563", "Éléonore Asselin", "2020-03-25", "572")));
		li.add(new Individual(	new User("Elita Quenneville", "elita.quenneville@noghasi.org", BCrypt.hashpw("totototo", BCrypt.gensalt()), UserRole.INDIVIDUAL, "03.40.10.61.98",	new Address("27, Chemin Challet", "", "59000", "Lille", "France", 00.00, 00.00), true , true, "F_0010.jpg"), 		new CreditCard("Visa", "5392 1701 5112 0249", "Elita Quenneville", "2020-03-21", "018")));
		li.add(new Individual(	new User("Geoffrey Verreau", "geoffrey.verreau@noghasi.org", BCrypt.hashpw("totototo", BCrypt.gensalt()), UserRole.INDIVIDUAL, "01.80.40.11.26", 	new Address("8, Avenue des Tuileries", "", "59113", "Seclin", "France", 00.00, 00.00), true , true, "H_0017.jpg"), new CreditCard("MasterCard", "5163 6444 7073 0919", "Geoffrey Verreau", "2020-02-24", "833")));
		li.add(new Individual(	new User("Delmar Dumont", "delmar.dumont@noghasi.org", BCrypt.hashpw("totototo", BCrypt.gensalt()), UserRole.INDIVIDUAL, "03.45.59.69.12", 			new Address("66, Rue St Ferréol", "", "59113", "Seclin", "France", 00.00, 00.00), true , true, "H_0004.jpg"),		new CreditCard("Visa", "4532 8751 8101 7868", "Delmar Dumont", "2020-08-24", "820")));
		li.add(new Individual(	new User("Nathalie Gabriaux", "nathalie.gabriaux@noghasi.org", BCrypt.hashpw("totototo", BCrypt.gensalt()), UserRole.INDIVIDUAL, "01.62.58.77.00",	new Address("13, rue Gouin de Beauchesne", "", "59680", "Wattignies", "France", 00.00, 00.00), true , true, "F_0007.jpg"), new CreditCard("MasterCard", "4929 5131 5748 7382", "Nathalie Gabriaux", "2020-06-23", "590")));
		li.add(new Individual(	new User("Charles Margand", "charles.margand@noghasi.org", BCrypt.hashpw("totototo", BCrypt.gensalt()), UserRole.INDIVIDUAL, "01.65.89.96.02", 		new Address("13, rue Gouin de Beauchesne", "", "59680", "Wattignies", "France", 00.00, 00.00), true , true, "H_0002.jpg"), new CreditCard("Visa", "4556 7288 3650 6226", "Charles Margand", "2020-12-22", "095")));
		...
		la.add(new Association(	new User("Les Gars'pilleurs", "lesgarspilleurs@gmail.com", BCrypt.hashpw("totototo", BCrypt.gensalt()), UserRole.ASSOCIATION, "06.22.99.87.92",	 			new Address("", "", "59000", "Lille", "France", 00.00, 00.00), true , true, "LesGarspilleurs.png"), "362 521 878", "W751212518") );
		...
		// TODO Ajouter les images pour chaque produit
		/* Produits Basilic */
