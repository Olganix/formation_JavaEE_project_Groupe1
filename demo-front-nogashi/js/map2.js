...
class Map2 {
  constructor() {
        ...
        this.iconeMap = L.icon({  //Icone Open
           ...
           iconSize: [75, 105], //Taille icone  [largeur, hauteur]
   ...
   //OPENSTREETMAP
   carte() {
       this.mapTile = L.map('mapid').setView([50.63609, 3.06387], 15);
   ...
   addMarker() {
       let marker = L.marker([50.73845, 3.18781]).addTo(this.mapTile).setIcon(this.iconeMap).bindPopup("Tourcoing 59200");   
   }//Fin addMarker()   
